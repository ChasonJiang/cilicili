...
class IMDN_E(nn.Module):
    def __init__(self, in_nc=3, nf=24, num_modules=5, out_nc=3, upscale=2):
        super(IMDN_E, self).__init__()
        ...
        final_conv = [B.conv_layer(out_nc, out_nc, kernel_size=3)]
