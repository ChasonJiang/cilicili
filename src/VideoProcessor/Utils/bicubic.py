...
def imresize(img, scale, antialiasing=True):
    ...
    Returns:
        ...
        Tensor: Output image with shape (c, h, w), [0, 1] range, w/o round, If input a Tensor
        Numpy array: Output image with shape (h, w, c), [0, 1] range, w/o round, If input a Numpy array
    """
...
if __name__=="__main__":
    img = torch.randn((3,512,512)).cuda()
    imresize(img,2,True)